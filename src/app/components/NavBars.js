        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex h-20 items-center">
            ...
            <div className="ml-auto hidden md:flex items-center gap-6 pr-1 text-[14px] font-semibold">
              <NavLink href="/oversea-partner" pathname={pathname}>
                For Oversea Partners
              </NavLink>
          ...
          <div className="md:hidden bg-white border-t border-gray-200 px-6 py-4 space-y-3">
            ...
            <div>
              <button
                ...
                className="flex w-full items-center justify-between py-2 text-[15px] font-medium text-gray-800"
              >
...
function MobileNavLink({ href, pathname, children, onClick }) {
  ...
  return (
    <Link
      href={href}
      onClick={onClick}
      className={`block py-2 text-[15px] transition ${
        isActive
          ? "text-blue-600 font-semibold"
          : "text-gray-800 hover:text-blue-600"
      }`}
...
function ServiceItem({ href, children }) {
  return (
    <li>
      <Link
        href={href}
        className="block px-5 py-2 text-gray-700 hover:bg-gray-50 hover:text-blue-600 transition"
      >
        {children}
      </Link>
    </li>
