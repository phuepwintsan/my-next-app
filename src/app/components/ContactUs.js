      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-12">
            ...
            <div className="mx-auto w-full max-w-xl rounded-lg bg-gray-100 px-8 py-10 text-center">
          ...
          <div className="rounded-xl border border-gray-200 bg-white px-8 pb-8 pt-4">
            ...
            {/* ❗ Contact Form heading – UNCHANGED */}
              ...
              <FormField label="Date">
                <input
                  ...
                  className="w-48 rounded-lg border border-gray-200 bg-gray-200
                             px-4 py-3 text-sm text-gray-500 outline-none
              ...
              <FormField label="Message">
                <textarea
                  ...
                  className="w-full rounded-lg border border-gray-200 bg-gray-200
                             px-4 py-3 text-sm text-gray-800 placeholder-gray-500
...
function InfoCard({ title, value, image }) {
  ...
  return (
    <div className="flex min-h-[220px] flex-col items-center rounded-xl
                    border border-gray-200 bg-white px-8 py-8 text-center
                    transition hover:border-blue-500 hover:shadow-sm">
      <h3 className="text-xs font-medium tracking-widest text-gray-800">
        {title}
      </h3>
      ...
      <img src={`/${image}`} alt="" className="mt-6 h-9 w-9 opacity-90" />
    </div>
  );
}
...
function QRCard({ src }) {
  return (
    <div className="flex h-[120px] w-[120px] items-center justify-center rounded-md bg-white shadow-sm">
